...
CHARLS_IMEXPORT(JLS_ERROR) CHARLS_CALLCONV JpegLsEncode(void* compressedData, size_t compressedLength, size_t* pcbyteWritten, const void* uncompressedData, size_t uncompressedLength, struct JlsParameters* pparams)
{
...
CHARLS_IMEXPORT(JLS_ERROR) CHARLS_CALLCONV JpegLsDecode(void* uncompressedData, size_t uncompressedLength, const void* compressedData, size_t compressedLength, JlsParameters* info)
{
...
CHARLS_IMEXPORT(JLS_ERROR) CHARLS_CALLCONV JpegLsDecodeRect(void* uncompressedData, size_t uncompressedLength, const void* compressedData, size_t compressedLength, JlsRect roi, JlsParameters* info)
{
	JLSInputStream reader((BYTE*)compressedData, compressedLength);
...
CHARLS_IMEXPORT(JLS_ERROR) CHARLS_CALLCONV JpegLsVerifyEncode(const void* uncompressedData, size_t uncompressedLength, const void* compressedData, size_t compressedLength)
{
...
CHARLS_IMEXPORT(JLS_ERROR) CHARLS_CALLCONV JpegLsReadHeader(const void* compressedData, size_t compressedLength, JlsParameters* pparams)
{
	try
	{
		JLSInputStream reader((BYTE*)compressedData, compressedLength);
